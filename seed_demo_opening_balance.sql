...
-- ================================================
--
-- WARNING: NOT PART OF THE 3-FILE CORE SETUP. NOT FOR PRODUCTION.
...
-- never see the large, unfixed 462,100 GEL number on screen at all, even
...
-- 462,100 GEL every month by accident. Not needed for a real deployment --
...
-- payments to offset that backlog, 1410's cumulative-through-
-- April-30 balance is large -- 462,100 GEL -- because it's the sum of every
...
-- (opening balance adjustment, demo only) / Cr 1410 for
-- 426,550.00 GEL, dated 2026-04-01 -- representing "everything owed as of
...
--
-- 35,550.00 GEL is not an arbitrary target -- it's the sum of every
...
-- 35,550.00 GEL after running this file, the cumulative-balance fix is
